...
if((isset($_POST["passwordContacto"]))&&($_POST["passwordContacto"]!="")){ $passwordCliente=strip_tags(htmlentities(mysqli_real_escape_string($link, $_POST["passwordContacto"]))); } else {$aErrores[] = "Debe introducir un password";}
