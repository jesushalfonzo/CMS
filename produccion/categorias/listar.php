                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title">Cantidad de ofertas </th>
                      ...
                      <tbody>
                        ...
                        <?php
                        $SQL="SELECT * FROM m_categorias ORDER BY m_categoria_nombre ASC";
                        ...
                        while ($row=mysqli_fetch_array($query)) {
                          ...
                          if ($m_categoria_estatus) {
                            $m_categoria_estatus="ACTIVA";
                            $icon="power-off";
                            $text="Desactivar categoría";
                            $nextStatus=0;
                            $color="success";
                          } else {
                            $m_categoria_estatus="INACTIVA";
                            $icon="check";
                            $text="Activar categoría";
                            $nextStatus=1;
                            $color="warning";
                          }
...
$(".EDITANDO").click(function (e) {
  ...
  window.location.href = 'editarCategory.php?idCategory='+idEditar;
});
//FIN DEL EDITAR
...
function changeStatus(){
  ...
  $.ajax({
    ...
    type: 'GET',
    enctype: 'multipart/form-data',
    data: "idCategory="+id+"&nextStatus="+nextStatus,
    async: false,
    contentType: "application/json",
    dataType: "json",
    success: function (data) {
